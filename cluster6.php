...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="ui grid container" style="margin: 40px!important">
      <br>
      <div class="row">
        <h2>Training set Cluster 6</h2>
        <?php
          $query = $db->query("UPDATE tb_training SET C6DC1='0', C6DC2='0', C6DC3='0', C6DC4='0', C6DC5='0', C6DC6='0', C_before='', C_after='', hasil='0'");
          ...
          do {
            ...
            $acak_C6 = rand(1, $rowCount);
          } while ($acak_C1==$acak_C2 && $acak_C1==$acak_C3 && $acak_C1==$acak_C4 && $acak_C1==$acak_C5 && $acak_C1==$acak_C6 && $acak_C2==$acak_C3 && $acak_C2==$acak_C4 && $acak_C2==$acak_C5 && $acak_C2==$acak_C6 && $acak_C3==$acak_C4 && $acak_C3==$acak_C5 && $acak_C3==$acak_C6 && $acak_C4==$acak_C5 && $acak_C4==$acak_C6 && $acak_C5==$acak_C6);
        ?>
      </div>
      <div class="row">
          ...
          <table class="ui celled center aligned collapsing small table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <?php
                  $acak_C6 = 6;
                  $query = $db->query("SELECT Daya_WBP_1, Daya_LWBP_1, Daya_WBP_2, Daya_LWBP_2, Daya_WBP_3, Daya_LWBP_3, Daya_WBP_4, Daya_LWBP_4, Daya_WBP_5, Daya_LWBP_5, Daya_WBP_6, Daya_LWBP_6, Daya_WBP_7, Daya_LWBP_7 FROM tb_training WHERE pelanggan = '$acak_C6'");
                  while ($result = $query->fetch()) {
                    $C6_Daya_WBP_1=$result['Daya_WBP_1']; $C6_Daya_LWBP_1=$result['Daya_LWBP_1'];
                    $C6_Daya_WBP_2=$result['Daya_WBP_2']; $C6_Daya_LWBP_2=$result['Daya_LWBP_2'];
                    $C6_Daya_WBP_3=$result['Daya_WBP_3']; $C6_Daya_LWBP_3=$result['Daya_LWBP_3'];
                    $C6_Daya_WBP_4=$result['Daya_WBP_4']; $C6_Daya_LWBP_4=$result['Daya_LWBP_4'];
                    $C6_Daya_WBP_5=$result['Daya_WBP_5']; $C6_Daya_LWBP_5=$result['Daya_LWBP_5'];
                    $C6_Daya_WBP_6=$result['Daya_WBP_6']; $C6_Daya_LWBP_6=$result['Daya_LWBP_6'];
                    $C6_Daya_WBP_7=$result['Daya_WBP_7']; $C6_Daya_LWBP_7=$result['Daya_LWBP_7'];
                    for ($i=0; $i < 14; $i++) {
                ?>
                <td><?php echo $result[$i] ?></td>
                <?php
                ...
                <?php
                  ...
                  while ($result=$q->fetch()) {
                    ...
                    $DC1 =
                      ...
                      $DC6 =
                        sqrt(
                          pow(($result['Daya_WBP_1']-$C6_Daya_WBP_1), 2) + pow(($result['Daya_LWBP_1']-$C6_Daya_LWBP_1), 2) +
                          pow(($result['Daya_WBP_2']-$C6_Daya_WBP_2), 2) + pow(($result['Daya_LWBP_2']-$C6_Daya_LWBP_2), 2) +
                          pow(($result['Daya_WBP_3']-$C6_Daya_WBP_3), 2) + pow(($result['Daya_LWBP_3']-$C6_Daya_LWBP_3), 2) +
                          pow(($result['Daya_WBP_4']-$C6_Daya_WBP_4), 2) + pow(($result['Daya_LWBP_4']-$C6_Daya_LWBP_4), 2) +
                          pow(($result['Daya_WBP_5']-$C6_Daya_WBP_5), 2) + pow(($result['Daya_LWBP_5']-$C6_Daya_LWBP_5), 2) +
                          pow(($result['Daya_WBP_6']-$C6_Daya_WBP_6), 2) + pow(($result['Daya_LWBP_6']-$C6_Daya_LWBP_6), 2) +
                          pow(($result['Daya_WBP_7']-$C6_Daya_WBP_7), 2) + pow(($result['Daya_LWBP_7']-$C6_Daya_LWBP_7), 2)
                        );

                      if(min($DC1,$DC2,$DC3,$DC4,$DC5,$DC6)==$DC1) {
                        $C='C1';
                      } else if(min($DC1,$DC2,$DC3,$DC4,$DC5,$DC6)==$DC2) {
                        $C='C2';
                      } else if(min($DC1,$DC2,$DC3,$DC4,$DC5,$DC6)==$DC3) {
                        $C='C3';
                      } else if(min($DC1,$DC2,$DC3,$DC4,$DC5,$DC6)==$DC4) {
                        $C='C4';
                      } else if(min($DC1,$DC2,$DC3,$DC4,$DC5,$DC6)==$DC5) {
                        $C='C5';
                      } else if(min($DC1,$DC2,$DC3,$DC4,$DC5,$DC6)==$DC6) {
                        $C='C6';
                      }
                          $query = $db->query("UPDATE tb_training SET C6DC1='$DC1', C6DC2='$DC2', C6DC3='$DC3', C6DC4='$DC4', C6DC5='$DC5', C6DC6='$DC6', C_before='$C' WHERE pelanggan='$pelanggan'");
                  }
                ?>
                <td colspan="3">DC1</td>
        ...
        <div class="sixteen wide column">
          ...
          <?php
            ...
            for ($i = 1; $i <= 2; $i++) {
              ...
              // Cari rata-rata C6
              $query = $db->query("SELECT * FROM tb_training WHERE C_before='C6'");
              $C6_Daya_WBP_1_sum=0; $C6_Daya_LWBP_1_sum=0;
              $C6_Daya_WBP_2_sum=0; $C6_Daya_LWBP_2_sum=0;
              $C6_Daya_WBP_3_sum=0; $C6_Daya_LWBP_3_sum=0;
              $C6_Daya_WBP_4_sum=0; $C6_Daya_LWBP_4_sum=0;
              $C6_Daya_WBP_5_sum=0; $C6_Daya_LWBP_5_sum=0;
              $C6_Daya_WBP_6_sum=0; $C6_Daya_LWBP_6_sum=0;
              $C6_Daya_WBP_7_sum=0; $C6_Daya_LWBP_7_sum=0;
              $C6_jml_data=0;

              while($res = $query->fetch()){
                $C6_jml_data++;
                $C6_Daya_WBP_1_sum+=$res['Daya_WBP_1']; $C6_Daya_LWBP_1_sum+=$res['Daya_LWBP_1'];
                $C6_Daya_WBP_2_sum+=$res['Daya_WBP_2']; $C6_Daya_LWBP_2_sum+=$res['Daya_LWBP_2'];
                $C6_Daya_WBP_3_sum+=$res['Daya_WBP_3']; $C6_Daya_LWBP_3_sum+=$res['Daya_LWBP_3'];
                $C6_Daya_WBP_4_sum+=$res['Daya_WBP_4']; $C6_Daya_LWBP_4_sum+=$res['Daya_LWBP_4'];
                $C6_Daya_WBP_5_sum+=$res['Daya_WBP_5']; $C6_Daya_LWBP_5_sum+=$res['Daya_LWBP_5'];
                $C6_Daya_WBP_6_sum+=$res['Daya_WBP_6']; $C6_Daya_LWBP_6_sum+=$res['Daya_LWBP_6'];
                $C6_Daya_WBP_7_sum+=$res['Daya_WBP_7']; $C6_Daya_LWBP_7_sum+=$res['Daya_LWBP_7'];
              }

              $C6_Daya_WBP_1_avg=$C6_Daya_WBP_1_sum/$C6_jml_data; $C6_Daya_LWBP_1_avg=$C6_Daya_LWBP_1_sum/$C6_jml_data;
              $C6_Daya_WBP_2_avg=$C6_Daya_WBP_2_sum/$C6_jml_data; $C6_Daya_LWBP_2_avg=$C6_Daya_LWBP_2_sum/$C6_jml_data;
              $C6_Daya_WBP_3_avg=$C6_Daya_WBP_3_sum/$C6_jml_data; $C6_Daya_LWBP_3_avg=$C6_Daya_LWBP_3_sum/$C6_jml_data;
              $C6_Daya_WBP_4_avg=$C6_Daya_WBP_4_sum/$C6_jml_data; $C6_Daya_LWBP_4_avg=$C6_Daya_LWBP_4_sum/$C6_jml_data;
              $C6_Daya_WBP_5_avg=$C6_Daya_WBP_5_sum/$C6_jml_data; $C6_Daya_LWBP_5_avg=$C6_Daya_LWBP_5_sum/$C6_jml_data;
              $C6_Daya_WBP_6_avg=$C6_Daya_WBP_6_sum/$C6_jml_data; $C6_Daya_LWBP_6_avg=$C6_Daya_LWBP_6_sum/$C6_jml_data;
              $C6_Daya_WBP_7_avg=$C6_Daya_WBP_7_sum/$C6_jml_data; $C6_Daya_LWBP_7_avg=$C6_Daya_LWBP_7_sum/$C6_jml_data;
              ...
              while($res = $result->fetch()){
                ...
                $DC6 = sqrt(
                  pow(($res['Daya_WBP_1']-$C6_Daya_WBP_1_avg), 2) + pow(($res['Daya_LWBP_1']-$C6_Daya_LWBP_1_avg), 2) +
                  pow(($res['Daya_WBP_2']-$C6_Daya_WBP_2_avg), 2) + pow(($res['Daya_LWBP_2']-$C6_Daya_LWBP_2_avg), 2) +
                  pow(($res['Daya_WBP_3']-$C6_Daya_WBP_3_avg), 2) + pow(($res['Daya_LWBP_3']-$C6_Daya_LWBP_3_avg), 2) +
                  pow(($res['Daya_WBP_4']-$C6_Daya_WBP_4_avg), 2) + pow(($res['Daya_LWBP_4']-$C6_Daya_LWBP_4_avg), 2) +
                  pow(($res['Daya_WBP_5']-$C6_Daya_WBP_5_avg), 2) + pow(($res['Daya_LWBP_5']-$C6_Daya_LWBP_5_avg), 2) +
                  pow(($res['Daya_WBP_6']-$C6_Daya_WBP_6_avg), 2) + pow(($res['Daya_LWBP_6']-$C6_Daya_LWBP_6_avg), 2) +
                  pow(($res['Daya_WBP_7']-$C6_Daya_WBP_7_avg), 2) + pow(($res['Daya_LWBP_7']-$C6_Daya_LWBP_7_avg), 2)
                );
                if(min($DC1,$DC2,$DC3,$DC4,$DC5,$DC6)==$DC1) {
                  $C='C1';
                } else if(min($DC1,$DC2,$DC3,$DC4,$DC5,$DC6)==$DC2) {
                ...
                $query = $db->query("UPDATE tb_training SET C6DC1='$DC1', C6DC2='$DC2', C6DC3='$DC3', C6DC4='$DC4', C6DC5='$DC5', C6DC6='$DC6', C_after='$C' WHERE pelanggan='$pelanggan'");
              }
          ...
          ?>
          <h5>Iterasi ke-<?php echo $iterasi ?> <br> <small>Jumlah data C1: <?php echo $C1_jml_data ?></small> | <small>Jumlah data C2: <?php echo $C2_jml_data ?></small> | <small>Jumlah data C3: <?php echo $C3_jml_data ?></small> | <small>Jumlah data C4: <?php echo $C4_jml_data ?></small> | <small>Jumlah data C5: <?php echo $C5_jml_data ?></small> | <small>Jumlah data C6: <?php echo $C6_jml_data ?></small></h5>
          ...
          <table class="ui celled center aligned collapsing small table">
            ...
            <tbody>
              ...
              <tr>
                <td>Cluster 6</td>
                <td><?php echo number_format($C6_Daya_WBP_1_avg,3, '.',',') ?></td>
                <td><?php echo number_format($C6_Daya_LWBP_1_avg,3, '.',',') ?></td>
                <td><?php echo number_format($C6_Daya_WBP_2_avg,3, '.',',') ?></td>
                <td><?php echo number_format($C6_Daya_LWBP_2_avg,3, '.',',') ?></td>
                <td><?php echo number_format($C6_Daya_WBP_3_avg,3, '.',',') ?></td>
                <td><?php echo number_format($C6_Daya_LWBP_3_avg,3, '.',',') ?></td>
                <td><?php echo number_format($C6_Daya_WBP_4_avg,3, '.',',') ?></td>
                <td><?php echo number_format($C6_Daya_LWBP_4_avg,3, '.',',') ?></td>
                <td><?php echo number_format($C6_Daya_WBP_5_avg,3, '.',',') ?></td>
                <td><?php echo number_format($C6_Daya_LWBP_5_avg,3, '.',',') ?></td>
                <td><?php echo number_format($C6_Daya_WBP_6_avg,3, '.',',') ?></td>
                <td><?php echo number_format($C6_Daya_LWBP_6_avg,3, '.',',') ?></td>
                <td><?php echo number_format($C6_Daya_WBP_7_avg,3, '.',',') ?></td>
                <td><?php echo number_format($C6_Daya_LWBP_7_avg,3, '.',',') ?></td>
              </tr>
            </tbody>
          </table>
          <?php
          ...
          <table class="ui celled center aligned collapsing small table">
            <?php
              ...
              $query = $db->query("SELECT * FROM tb_training WHERE C_after = 'C6'");
              $S6 = 0;
              $jml_C6 = 0;
              while($res = $query->fetch()){
                $jml_C6++;
              ...
              $M16 =
                sqrt(
                  pow(($C1_Daya_WBP_1_avg-$C6_Daya_WBP_1_avg), 2) + pow(($C1_Daya_LWBP_1_avg-$C6_Daya_LWBP_1_avg), 2) +
                  pow(($C1_Daya_WBP_2_avg-$C6_Daya_WBP_2_avg), 2) + pow(($C1_Daya_LWBP_2_avg-$C6_Daya_LWBP_2_avg), 2) +
                  pow(($C1_Daya_WBP_3_avg-$C6_Daya_WBP_3_avg), 2) + pow(($C1_Daya_LWBP_3_avg-$C6_Daya_LWBP_3_avg), 2) +
                  pow(($C1_Daya_WBP_4_avg-$C6_Daya_WBP_4_avg), 2) + pow(($C1_Daya_LWBP_4_avg-$C6_Daya_LWBP_4_avg), 2) +
                  pow(($C1_Daya_WBP_5_avg-$C6_Daya_WBP_5_avg), 2) + pow(($C1_Daya_LWBP_5_avg-$C6_Daya_LWBP_5_avg), 2) +
                  pow(($C1_Daya_WBP_6_avg-$C6_Daya_WBP_6_avg), 2) + pow(($C1_Daya_LWBP_6_avg-$C6_Daya_LWBP_6_avg), 2) +
                  pow(($C1_Daya_WBP_7_avg-$C6_Daya_WBP_7_avg), 2) + pow(($C1_Daya_LWBP_7_avg-$C6_Daya_LWBP_7_avg), 2)
                );
              $M21 =
                sqrt(
              ...
              $M26 =
                sqrt(
                  pow(($C2_Daya_WBP_1_avg-$C6_Daya_WBP_1_avg), 2) + pow(($C2_Daya_LWBP_1_avg-$C6_Daya_LWBP_1_avg), 2) +
                  pow(($C2_Daya_WBP_2_avg-$C6_Daya_WBP_2_avg), 2) + pow(($C2_Daya_LWBP_2_avg-$C6_Daya_LWBP_2_avg), 2) +
                  pow(($C2_Daya_WBP_3_avg-$C6_Daya_WBP_3_avg), 2) + pow(($C2_Daya_LWBP_3_avg-$C6_Daya_LWBP_3_avg), 2) +
                  pow(($C2_Daya_WBP_4_avg-$C6_Daya_WBP_4_avg), 2) + pow(($C2_Daya_LWBP_4_avg-$C6_Daya_LWBP_4_avg), 2) +
                  pow(($C2_Daya_WBP_5_avg-$C6_Daya_WBP_5_avg), 2) + pow(($C2_Daya_LWBP_5_avg-$C6_Daya_LWBP_5_avg), 2) +
                  pow(($C2_Daya_WBP_6_avg-$C6_Daya_WBP_6_avg), 2) + pow(($C2_Daya_LWBP_6_avg-$C6_Daya_LWBP_6_avg), 2) +
                  pow(($C2_Daya_WBP_7_avg-$C6_Daya_WBP_7_avg), 2) + pow(($C2_Daya_LWBP_7_avg-$C6_Daya_LWBP_7_avg), 2)
                );
              $M31 =
                sqrt(
              ...
              $M36 =
                sqrt(
                  pow(($C3_Daya_WBP_1_avg-$C6_Daya_WBP_1_avg), 2) + pow(($C3_Daya_LWBP_1_avg-$C6_Daya_LWBP_1_avg), 2) +
                  pow(($C3_Daya_WBP_2_avg-$C6_Daya_WBP_2_avg), 2) + pow(($C3_Daya_LWBP_2_avg-$C6_Daya_LWBP_2_avg), 2) +
                  pow(($C3_Daya_WBP_3_avg-$C6_Daya_WBP_3_avg), 2) + pow(($C3_Daya_LWBP_3_avg-$C6_Daya_LWBP_3_avg), 2) +
                  pow(($C3_Daya_WBP_4_avg-$C6_Daya_WBP_4_avg), 2) + pow(($C3_Daya_LWBP_4_avg-$C6_Daya_LWBP_4_avg), 2) +
                  pow(($C3_Daya_WBP_5_avg-$C6_Daya_WBP_5_avg), 2) + pow(($C3_Daya_LWBP_5_avg-$C6_Daya_LWBP_5_avg), 2) +
                  pow(($C3_Daya_WBP_6_avg-$C6_Daya_WBP_6_avg), 2) + pow(($C3_Daya_LWBP_6_avg-$C6_Daya_LWBP_6_avg), 2) +
                  pow(($C3_Daya_WBP_7_avg-$C6_Daya_WBP_7_avg), 2) + pow(($C3_Daya_LWBP_7_avg-$C6_Daya_LWBP_7_avg), 2)
                );
              $M41 =
                sqrt(
              ...
              $M46 =
                sqrt(
                  pow(($C4_Daya_WBP_1_avg-$C6_Daya_WBP_1_avg), 2) + pow(($C4_Daya_LWBP_1_avg-$C6_Daya_LWBP_1_avg), 2) +
                  pow(($C4_Daya_WBP_2_avg-$C6_Daya_WBP_2_avg), 2) + pow(($C4_Daya_LWBP_2_avg-$C6_Daya_LWBP_2_avg), 2) +
                  pow(($C4_Daya_WBP_3_avg-$C6_Daya_WBP_3_avg), 2) + pow(($C4_Daya_LWBP_3_avg-$C6_Daya_LWBP_3_avg), 2) +
                  pow(($C4_Daya_WBP_4_avg-$C6_Daya_WBP_4_avg), 2) + pow(($C4_Daya_LWBP_4_avg-$C6_Daya_LWBP_4_avg), 2) +
                  pow(($C4_Daya_WBP_5_avg-$C6_Daya_WBP_5_avg), 2) + pow(($C4_Daya_LWBP_5_avg-$C6_Daya_LWBP_5_avg), 2) +
                  pow(($C4_Daya_WBP_6_avg-$C6_Daya_WBP_6_avg), 2) + pow(($C4_Daya_LWBP_6_avg-$C6_Daya_LWBP_6_avg), 2) +
                  pow(($C4_Daya_WBP_7_avg-$C6_Daya_WBP_7_avg), 2) + pow(($C4_Daya_LWBP_7_avg-$C6_Daya_LWBP_7_avg), 2)
                );
              $M51 =
                sqrt(
              ...
              $M56 =
                sqrt(
                  pow(($C5_Daya_WBP_1_avg-$C6_Daya_WBP_1_avg), 2) + pow(($C5_Daya_LWBP_1_avg-$C6_Daya_LWBP_1_avg), 2) +
                  pow(($C5_Daya_WBP_2_avg-$C6_Daya_WBP_2_avg), 2) + pow(($C5_Daya_LWBP_2_avg-$C6_Daya_LWBP_2_avg), 2) +
                  pow(($C5_Daya_WBP_3_avg-$C6_Daya_WBP_3_avg), 2) + pow(($C5_Daya_LWBP_3_avg-$C6_Daya_LWBP_3_avg), 2) +
                  pow(($C5_Daya_WBP_4_avg-$C6_Daya_WBP_4_avg), 2) + pow(($C5_Daya_LWBP_4_avg-$C6_Daya_LWBP_4_avg), 2) +
                  pow(($C5_Daya_WBP_5_avg-$C6_Daya_WBP_5_avg), 2) + pow(($C5_Daya_LWBP_5_avg-$C6_Daya_LWBP_5_avg), 2) +
                  pow(($C5_Daya_WBP_6_avg-$C6_Daya_WBP_6_avg), 2) + pow(($C5_Daya_LWBP_6_avg-$C6_Daya_LWBP_6_avg), 2) +
                  pow(($C5_Daya_WBP_7_avg-$C6_Daya_WBP_7_avg), 2) + pow(($C5_Daya_LWBP_7_avg-$C6_Daya_LWBP_7_avg), 2)
                );
              $M61 =
                sqrt(
                  pow(($C6_Daya_WBP_1_avg-$C1_Daya_WBP_1_avg), 2) + pow(($C6_Daya_LWBP_1_avg-$C1_Daya_LWBP_1_avg), 2) +
                  pow(($C6_Daya_WBP_2_avg-$C1_Daya_WBP_2_avg), 2) + pow(($C6_Daya_LWBP_2_avg-$C1_Daya_LWBP_2_avg), 2) +
                  pow(($C6_Daya_WBP_3_avg-$C1_Daya_WBP_3_avg), 2) + pow(($C6_Daya_LWBP_3_avg-$C1_Daya_LWBP_3_avg), 2) +
                  pow(($C6_Daya_WBP_4_avg-$C1_Daya_WBP_4_avg), 2) + pow(($C6_Daya_LWBP_4_avg-$C1_Daya_LWBP_4_avg), 2) +
                  pow(($C6_Daya_WBP_5_avg-$C1_Daya_WBP_5_avg), 2) + pow(($C6_Daya_LWBP_5_avg-$C1_Daya_LWBP_5_avg), 2) +
                  pow(($C6_Daya_WBP_6_avg-$C1_Daya_WBP_6_avg), 2) + pow(($C6_Daya_LWBP_6_avg-$C1_Daya_LWBP_6_avg), 2) +
                  pow(($C6_Daya_WBP_7_avg-$C1_Daya_WBP_7_avg), 2) + pow(($C6_Daya_LWBP_7_avg-$C1_Daya_LWBP_7_avg), 2)
                );
              $M62 =
                sqrt(
                  pow(($C6_Daya_WBP_1_avg-$C2_Daya_WBP_1_avg), 2) + pow(($C6_Daya_LWBP_1_avg-$C2_Daya_LWBP_1_avg), 2) +
                  pow(($C6_Daya_WBP_2_avg-$C2_Daya_WBP_2_avg), 2) + pow(($C6_Daya_LWBP_2_avg-$C2_Daya_LWBP_2_avg), 2) +
                  pow(($C6_Daya_WBP_3_avg-$C2_Daya_WBP_3_avg), 2) + pow(($C6_Daya_LWBP_3_avg-$C2_Daya_LWBP_3_avg), 2) +
                  pow(($C6_Daya_WBP_4_avg-$C2_Daya_WBP_4_avg), 2) + pow(($C6_Daya_LWBP_4_avg-$C2_Daya_LWBP_4_avg), 2) +
                  pow(($C6_Daya_WBP_5_avg-$C2_Daya_WBP_5_avg), 2) + pow(($C6_Daya_LWBP_5_avg-$C2_Daya_LWBP_5_avg), 2) +
                  pow(($C6_Daya_WBP_6_avg-$C2_Daya_WBP_6_avg), 2) + pow(($C6_Daya_LWBP_6_avg-$C2_Daya_LWBP_6_avg), 2) +
                  pow(($C6_Daya_WBP_7_avg-$C2_Daya_WBP_7_avg), 2) + pow(($C6_Daya_LWBP_7_avg-$C2_Daya_LWBP_7_avg), 2)
                );
              $M63 =
                sqrt(
                  pow(($C6_Daya_WBP_1_avg-$C3_Daya_WBP_1_avg), 2) + pow(($C6_Daya_LWBP_1_avg-$C3_Daya_LWBP_1_avg), 2) +
                  pow(($C6_Daya_WBP_2_avg-$C3_Daya_WBP_2_avg), 2) + pow(($C6_Daya_LWBP_2_avg-$C3_Daya_LWBP_2_avg), 2) +
                  pow(($C6_Daya_WBP_3_avg-$C3_Daya_WBP_3_avg), 2) + pow(($C6_Daya_LWBP_3_avg-$C3_Daya_LWBP_3_avg), 2) +
                  pow(($C6_Daya_WBP_4_avg-$C3_Daya_WBP_4_avg), 2) + pow(($C6_Daya_LWBP_4_avg-$C3_Daya_LWBP_4_avg), 2) +
                  pow(($C6_Daya_WBP_5_avg-$C3_Daya_WBP_5_avg), 2) + pow(($C6_Daya_LWBP_5_avg-$C3_Daya_LWBP_5_avg), 2) +
                  pow(($C6_Daya_WBP_6_avg-$C3_Daya_WBP_6_avg), 2) + pow(($C6_Daya_LWBP_6_avg-$C3_Daya_LWBP_6_avg), 2) +
                  pow(($C6_Daya_WBP_7_avg-$C3_Daya_WBP_7_avg), 2) + pow(($C6_Daya_LWBP_7_avg-$C3_Daya_LWBP_7_avg), 2)
                );
              $M64 =
                sqrt(
                  pow(($C6_Daya_WBP_1_avg-$C4_Daya_WBP_1_avg), 2) + pow(($C6_Daya_LWBP_1_avg-$C4_Daya_LWBP_1_avg), 2) +
                  pow(($C6_Daya_WBP_2_avg-$C4_Daya_WBP_2_avg), 2) + pow(($C6_Daya_LWBP_2_avg-$C4_Daya_LWBP_2_avg), 2) +
                  pow(($C6_Daya_WBP_3_avg-$C4_Daya_WBP_3_avg), 2) + pow(($C6_Daya_LWBP_3_avg-$C4_Daya_LWBP_3_avg), 2) +
                  pow(($C6_Daya_WBP_4_avg-$C4_Daya_WBP_4_avg), 2) + pow(($C6_Daya_LWBP_4_avg-$C4_Daya_LWBP_4_avg), 2) +
                  pow(($C6_Daya_WBP_5_avg-$C4_Daya_WBP_5_avg), 2) + pow(($C6_Daya_LWBP_5_avg-$C4_Daya_LWBP_5_avg), 2) +
                  pow(($C6_Daya_WBP_6_avg-$C4_Daya_WBP_6_avg), 2) + pow(($C6_Daya_LWBP_6_avg-$C4_Daya_LWBP_6_avg), 2) +
                  pow(($C6_Daya_WBP_7_avg-$C4_Daya_WBP_7_avg), 2) + pow(($C6_Daya_LWBP_7_avg-$C4_Daya_LWBP_7_avg), 2)
                );
              $M65 =
                sqrt(
                  pow(($C6_Daya_WBP_1_avg-$C5_Daya_WBP_1_avg), 2) + pow(($C6_Daya_LWBP_1_avg-$C5_Daya_LWBP_1_avg), 2) +
                  pow(($C6_Daya_WBP_2_avg-$C5_Daya_WBP_2_avg), 2) + pow(($C6_Daya_LWBP_2_avg-$C5_Daya_LWBP_2_avg), 2) +
                  pow(($C6_Daya_WBP_3_avg-$C5_Daya_WBP_3_avg), 2) + pow(($C6_Daya_LWBP_3_avg-$C5_Daya_LWBP_3_avg), 2) +
                  pow(($C6_Daya_WBP_4_avg-$C5_Daya_WBP_4_avg), 2) + pow(($C6_Daya_LWBP_4_avg-$C5_Daya_LWBP_4_avg), 2) +
                  pow(($C6_Daya_WBP_5_avg-$C5_Daya_WBP_5_avg), 2) + pow(($C6_Daya_LWBP_5_avg-$C5_Daya_LWBP_5_avg), 2) +
                  pow(($C6_Daya_WBP_6_avg-$C5_Daya_WBP_6_avg), 2) + pow(($C6_Daya_LWBP_6_avg-$C5_Daya_LWBP_6_avg), 2) +
                  pow(($C6_Daya_WBP_7_avg-$C5_Daya_WBP_7_avg), 2) + pow(($C6_Daya_LWBP_7_avg-$C5_Daya_LWBP_7_avg), 2)
                );
              ...
              $R61=($S6+$S1)/$M61; $R62=($S6+$S2)/$M62; $R63=($S6+$S3)/$M63; $R64=($S6+$S4)/$M64; $R65=($S6+$S5)/$M65;
              ...
              $query = "UPDATE tb_centroid SET
                ...
                username='' WHERE cluster='6' AND C='C1'";
              $db->query($query);
              $query = "UPDATE tb_centroid SET
                ...
                username='' WHERE cluster='6' AND C='C2'";
              $db->query($query);
              $query = "UPDATE tb_centroid SET
                ...
                username='' WHERE cluster='6' AND C='C3'";
              $db->query($query);
              $query = "UPDATE tb_centroid SET
                ...
                username='' WHERE cluster='6' AND C='C4'";
              $db->query($query);
              $query = "UPDATE tb_centroid SET
                ...
                username='' WHERE cluster='6' AND C='C5'";
              $db->query($query);
              $query = "UPDATE tb_centroid SET
                Daya_WBP_1=$C6_Daya_WBP_1_avg, Daya_LWBP_1=$C6_Daya_LWBP_1_avg,
                Daya_WBP_2=$C6_Daya_WBP_2_avg, Daya_LWBP_2=$C6_Daya_LWBP_2_avg,
                Daya_WBP_3=$C6_Daya_WBP_3_avg, Daya_LWBP_3=$C6_Daya_LWBP_3_avg,
                Daya_WBP_4=$C6_Daya_WBP_4_avg, Daya_LWBP_4=$C6_Daya_LWBP_4_avg,
                Daya_WBP_5=$C6_Daya_WBP_5_avg, Daya_LWBP_5=$C6_Daya_LWBP_5_avg,
                Daya_WBP_6=$C6_Daya_WBP_6_avg, Daya_LWBP_6=$C6_Daya_LWBP_6_avg,
                Daya_WBP_7=$C6_Daya_WBP_7_avg, Daya_LWBP_7=$C6_Daya_LWBP_7_avg,
                username='' WHERE cluster='6' AND C='C6'";
              $db->query($query);
            ?>
            <thead>
              <tr>
                <?php
                  $title = array('S1','S2','S3','S4','S5','S6');
          ...
          <table class="ui celled center aligned collapsing small table">
            <thead>
              <tr>
                <?php
                  $title = array('M12','M13','M14','M15','M16');
          ...
          <table class="ui celled center aligned collapsing small table">
            <thead>
              <tr>
                <?php
                  $title = array('M21','M23','M24','M25','M26');
          ...
          <table class="ui celled center aligned collapsing small table">
            <thead>
              <tr>
                <?php
                  $title = array('M31','M32','M34','M35','M36');
          ...
          <table class="ui celled center aligned collapsing small table">
            <thead>
              <tr>
                <?php
                  $title = array('M41','M42','M43','M45','M46');
          ...
          <table class="ui celled center aligned collapsing small table">
            <thead>
              <tr>
                <?php
                  $title = array('M51','M52','M53','M54','M56');
          ...
          <table class="ui celled center aligned collapsing small table">
            <thead>
              <tr>
                <?php
                  $title = array('R12','R13','R14','R15','R16');
          ...
          <table class="ui celled center aligned collapsing small table">
            <thead>
              <tr>
                <?php
                  $title = array('R21','R23','R24','R25','R26');
          ...
          <table class="ui celled center aligned collapsing small table">
            <thead>
              <tr>
                <?php
                  $title = array('R31','R32','R34','R35','R36');
          ...
          <table class="ui celled center aligned collapsing small table">
            <thead>
              <tr>
                <?php
                  $title = array('R41','R42','R43','R45','R46');
          ...
          <table class="ui celled center aligned collapsing small table">
            <thead>
              <tr>
                <?php
                  $title = array('D1','D2','D3','D4','D5','D6','DB');
        ...
        <a href="cluster6.php" class="ui disabled button">Training set Cluster 6</a>
        <a href="clusterOptimum.php" class="ui success  button">Optimum Cluster</a>
      </div>
    </div>
  </body>
</html>
